...
class AdapterEceranMenu(var context: Context, var list: List<ResponseSubMenu>?, val listener: OnAdapterListener)
    :RecyclerView.Adapter<AdapterEceranMenu.ItemHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemHolder {
        val itemHolder = LayoutInflater.from(parent.context).inflate(R.layout.rows_eceran_sub_menu, parent, false)
